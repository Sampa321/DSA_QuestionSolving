package ClassPractice.ProblemSolving.Geeksforgeeks.Stack.Medium.NextGreaterElement;
...
public class NaiveApproach {
    public static ArrayList<Integer> nextGreEle(int []arr){
   ...
   public static void main(String[] args) {
        int []arr = {5, 4, 3, 1};
       System.out.println(nextGreEle(arr));
    }
}
